...
int main(int argc, char * argv[])
{
    ...
    auto node_sub = std::make_shared<SubscriberNode>("usv_04_controller_sub", "/box_bot4/odom");
    auto node_pub = std::make_shared<PublisherNode>("usv_04_controller_pub", node_sub, "/box_bot4/cmd_vel");
