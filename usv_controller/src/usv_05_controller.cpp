...
int main(int argc, char * argv[])
{
    ...
    auto node_sub = std::make_shared<SubscriberNode>("usv_05_controller_sub", "/box_bot5/odom");
    auto node_pub = std::make_shared<PublisherNode>("usv_05_controller_pub", node_sub, "/box_bot5/cmd_vel");
