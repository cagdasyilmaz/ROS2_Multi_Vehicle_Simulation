...
int main(int argc, char * argv[])
{
    ...
    auto node_sub = std::make_shared<SubscriberNode>("usv_03_controller_sub", "/box_bot3/odom");
    auto node_pub = std::make_shared<PublisherNode>("usv_03_controller_pub", node_sub, "/box_bot3/cmd_vel");
